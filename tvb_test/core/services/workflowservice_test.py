...
#        self.clean_database()
    ...
    def test_workflow_generation(self):
        ...
        """  
        workflow_step_list = []
        workflow_step_list.append(TestFactory.create_workflow_step("tvb_test.adapters.testadapter2", "TestAdapter2", 
                                                                   static_kwargs = {"test2" : 2}, step_index = 1))
        workflow_step_list.append(TestFactory.create_workflow_step("tvb_test.adapters.testadapter1", "TestAdapter1", 
                                                                   static_kwargs = {"test1_val1" : 1, "test1_val2" : 1}, step_index = 2))
    ...
    def test_workflow_dynamic_params(self):
        ...
        workflow_step_list = []
        workflow_step_list.append(TestFactory.create_workflow_step("tvb_test.adapters.testadapter1", "TestAdapter1", 
                                                                   static_kwargs = {"test1_val1" : 1, "test1_val2" : 1}, step_index = 1))
        workflow_step_list.append(TestFactory.create_workflow_step("tvb_test.adapters.testadapter3", "TestAdapter3", 
                                                                   dynamic_kwargs = {"test":{wf_cfg.DATATYPE_INDEX_KEY:0, wf_cfg.STEP_INDEX_KEY:1}}, step_index = 2))
    ...
    def test_configuration2workflow(self):
        ...
        workflow_step = TestFactory.create_workflow_step("tvb_test.adapters.testadapter1", "TestAdapter1", 
                                                         ...
                                                         dynamic_kwargs = {"dynamic_param":{wf_cfg.STEP_INDEX_KEY : 0, wf_cfg.DATATYPE_INDEX_KEY : 0}}, 
