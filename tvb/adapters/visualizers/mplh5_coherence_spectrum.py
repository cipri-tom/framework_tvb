...
#    
    ...
    def _add_spectrum_mode_selector(self):
        ...
        """
        pos_shp = [CONTOLS_START_X, 0.07, CONTROLS_WIDTH, 
                   0.1+0.002*3]
        rax = self.figure.add_axes(pos_shp, axisbg=AXCOLOUR, title="Spectrum Mode")
        spectrum_mode_tuple = ("Re", "Imag", "Abs")
        self.spectrum_mode_selector = RadioButtons(rax, spectrum_mode_tuple, active=spectrum_mode_tuple.index(self.spectrum))
    ...
    def plot_spectra(self):
        ...
        #if self.is_preview: shape[2] = NR_OF_PREVIEW_CHANS
