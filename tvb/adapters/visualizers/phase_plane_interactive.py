...
#        self._set_parameters()
        ...
        self.ipp_fig.subplots_adjust(left=0.265, bottom=0.02, right=0.75,
...
#        self._add_reset_param_button()
        ...
        return dict(serverIp=config.SERVER_IP, serverPort=config.MPLH5_SERVER_PORT, figureNumber=self.ipp_fig.number, showFullToolbar=False)
    ...
    def _add_axes_range_sliders(self):
        ...
        sl_x_max = Slider(sax, "xhi", min_val_x, max_val_x,
        ...
        sax = self.ipp_fig.add_axes([0.04, 0.765, 0.125, 0.025],
                                    axisbg=AXCOLOUR)
        sl_y_min = Slider(sax, "ylo", min_val_y, max_val_y,
        ...
        sl_y_max = Slider(sax, "yhi", min_val_y, max_val_y,
    ...
    def _add_state_variable_sliders(self):
        ...
        for sv in range(self.model.nvar):
            ...
            self.sv_sliders[sv_str] = Slider(sax, sv_str,
                                             msv_range[sv_str][0],
                                             msv_range[sv_str][1],
    ...
    def _add_noise_slider(self):
        ...
        self.noise_slider = Slider(sax, "Noise", 0.0, 1.0,
    ...
    def _add_reset_sv_button(self):
        ...
        self.reset_sv_button = Button(bax, 'Reset state-variables',
                                      color=BUTTONCOLOUR,
    ...
    def _add_reset_noise_button(self):
        ...
        self.reset_noise_button = Button(bax, 'Reset noise strength',
                                         color=BUTTONCOLOUR,
                                         hovercolor=HOVERCOLOUR)
    ...
    def _add_reset_seed_button(self):
        ...
        self.reset_seed_button = Button(bax, 'Reset random stream',
                                        color=BUTTONCOLOUR,
                                        hovercolor=HOVERCOLOUR)
    ...
    def _add_reset_axes_button(self):
        ...
        self.reset_axes_button = Button(bax, 'Reset axes',
                                        color=BUTTONCOLOUR,
                                        hovercolor=HOVERCOLOUR)
...
#        """
#        Hopefully a temporary hack, new traits should take care of this.
#        """
#        self.parameters = {}
#        #import pdb; pdb.set_trace()
...
#            if (isinstance(attr, numpy.ndarray) and attr.size == 1):
#                self.parameters[key] = attr #.append(key)


#    def _update_parameters(self, val):
#        """
#        Update model parameters based on the current parameter slider values.
#
#        NOTE: Haven't figured out how to update independantly, so just update
...
#    def _add_reset_param_button(self):
#        """
...
#        self.reset_param_button = Button(bax, 'Reset parameters',
#                                         color=BUTTONCOLOUR,
#                                         hovercolor=HOVERCOLOUR)
...
#                                         axisbg=AXCOLOUR)
#            default_param = default_param[0] # getattr(self.model, param)
##            self.param_sliders[param] = Slider(sax, param,
##                self.model.trait[param].trait["range"]["lo"],
##                self.model.trait[param].trait["range"]["hi"],
##                valinit=default_param)
#            if default_param == 0:
#                self.param_sliders[param] = Slider(sax, param, -1.0, 1.0,
#                                                   valinit=default_param)
#            else:
#                param_extrm = 4.0*numpy.abs(default_param)
#                self.param_sliders[param] = Slider(sax, param,
#                                                   -param_extrm, param_extrm,
#                                                   valinit=default_param)
#            self.param_sliders[param].on_changed(self._update_parameters)