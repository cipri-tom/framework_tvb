...
function _getOpsForRanger(rangerValue) {
	...
	return Math.ceil((toVal - fromVal) / stepVal);
} 
...
function _computeNrOfOps() {
	...
	var msg = "Due to your simulator configuration a total of " + nrOps + " operations will be launched.";
	var className = "infoMessage";
	if (nrOps > 500) {
		className = "warningMessage";
		msg = "Warning! With the current simulator configuration you will launch " + nrOps + " operations.";
	} 
	if (nrOps > 50000) {
		className = "errorMessage";
		msg = "Due to simulator configurations you are about to launch " + nrOps + " operations. Are you sure?";
	}
